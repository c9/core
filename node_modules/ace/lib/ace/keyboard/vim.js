...
(function() {
  ...
  this.scrollIntoView = function(pos, margin) {
    if (pos) {
      var renderer = this.ace.renderer;
      var acePos = toAcePos(pos);
      renderer.session.unfold(acePos);
      renderer.session.selection.moveToPosition(acePos);
      renderer.scrollCursorIntoView(acePos, 0.5, {
        top: margin,
        bottom: margin
      });
      if (this.ace.curOp)
        this.ace.curOp.command.scrollIntoView = "animate";
    }
  };
    ...
    function dialog(cm, template, shortText, onClose, options) {
      if (cm.openDialog) {
        cm.openDialog(template, onClose, { bottom: true, value: options.value,
            onKeyDown: options.onKeyDown, onKeyUp: options.onKeyUp, closeOnBlur: false });
      }
      else {
